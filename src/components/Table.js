...
export const Table = () => {
        const {dropState, inputsState} = useContext(InputsContext)
        ...
        useEffect(() => {
            console.log("hshfsd", inputsState["expiry-drop"], inputsState["rows-count"])
                const run = setInterval(() => {
                    console.log("fetching with ", inputsState["expiry-drop"], inputsState["rows-count"])
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <tbody>
                    {rows.map((e, idx) => (
                        <TableRow key={idx} row={e} marketPrice={marketPrice}/>
                    ))}
                    <FinalRow/>
                    </tbody>
                </table>
